		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_bd_shdz clearfix">
				<div class="shop_bd_shdz_lists clearfix">
					<ul>
						<?php if(is_array($address)): foreach($address as $key=>$vo): ?><li><label>寄送至：<span><input type="radio" name="address" id="address" value="<?php echo ($vo["address_id"]); ?>"/></span></label><em>北京</em><em>北京市</em><em>昌平区</em><em><?php echo ($vo["street"]); ?></em><em><?php echo ($vo["consignee"]); ?>(收)</em><em><?php echo ($vo["mobile"]); ?></em></li><?php endforeach; endif; ?>	
					</ul>
				</div>
				<!-- 新增收货地址 -->
