...
<body>
	<div class="header wrap1000">
		<a href="/shop/index.php"><img src="/shop/Public/images/logo.png" alt="" /></a>
	</div>
	...
	<div class="main">
		<div class="login-form fr">
			...
			<div class="form-bd">
				<form action="" method="POST">
					...
					<dl>
						<dt>验证码</dt>
						<dd><input type="text" name="captcha" class="text" size="10" style="width:58px;"> <img src="/shop/index.php/Home/Login/code"  width="150" height="40" onclick= this.src="/shop/index.php/Home/Login/code/"+Math.random() alt="CAPTCHA" align="absmiddle" style="position:relative;top:-2px;" title="看不清，重新选一张" /></dd>
					<dl>
						<dt>&nbsp;</dt>
		...
		<div class="login-form-left fl">
			...
			<div class="if">
				<h2>如果您是本站用户</h2>
				<p>我已经注册过账号，立即 <a href="/shop/Home/Login/index" class="register">登录</a> 或是 <a href="/shop/index.php/Home/Login/password_eidt" class="findpwd">找回密码？</a></p>
			</div>
		</div>
	</div>
