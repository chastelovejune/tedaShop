			...
			<table>
				...
				<tbody>
                   ...
                   <?php if(is_array($goodsRes)): foreach($goodsRes as $key=>$vo): ?><tr>
						...
						<td class="gwc_list_shuliang"><span><a class="good_num_jian this_good_nums" did="danjia_001" xid="xiaoji_001" ty="-" valId="goods_001" href="/shop/index.php/Home/Shop/minus/goods_id/<?php echo ($vo["goods_id"]); ?>">-</a><input type="text" value="<?php echo ($vo["goods_num"]); ?>" id="goods_001" class="good_nums" /><a href="/shop/index.php/Home/Shop/add/goods_id/<?php echo ($vo["goods_id"]); ?>" did="danjia_001" xid="xiaoji_001" ty="+" class="good_num_jia this_good_nums" valId="goods_001">+</a></span></td>
						<td class="gwc_list_xiaoji"><span>￥<strong id="xiaoji_001" class="good_xiaojis" value="<?php echo ($vo["shop_price"]); ?>"><?php echo ($vo["shop_price"]); ?></strong></span></td>
						<td class="gwc_list_caozuo"><a href="">收藏</a><a href="/shop/index.php/Home/Shop/delete/goods_id/<?php echo ($vo["goods_id"]); ?>" class="shop_good_delete">删除</a></td>
