	...
	<div class="shop_goods_bd clear">
		...
		<div class="shop_goods_show">
			<div class="shop_goods_show_left">
				...
				<div id="preview">
					<div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="/shop<?php echo ($goods["goods_img"]); ?>" jqimg="/shop/Public/images/img04.jpg" width="350">
						</div>
						<div id="spec-n5">
							...
							<div id="spec-list">
								<ul class="list-h">
									<li><img src="__ROOT_<?php echo ($goods["goods_img"]); ?>"> </li>
									<li><img src="/shop<?php echo ($goods["goods_img"]); ?>"> </li>
									<li><img src="/shop<?php echo ($goods["goods_img"]); ?>"> </li>
									<li><img src="/shop<?php echo ($goods["goods_img"]); ?>"> </li>
									<li><img src="/shop<?php echo ($goods["goods_img"]); ?>"> </li>
									<li><img src="/shop<?php echo ($goods["goods_img"]); ?>"> </li>
					...
					function goumai(){
						if(document.getElementById('submit').action="/shop/index.php/Home/Shop/order"){
			...
			<div class="shop_goods_show_right">
				<ul>
					...
					<!--表单传值-->
					<form method="post" action="/shop/index.php/Home/Shop/addcart"  id="submit">
					<li class="goods_num">
						<label>购买数量：</label>
						<span><a class="good_num_jian" id="good_num_jian" href="javascript:void(0);"></a><input type="text" value="1" id="good_nums" class="good_nums" name="goods_num"/><a href="javascript:void(0);" id="good_num_jia" class="good_num_jia"></a>(当前库存0件)</span>
					</li>
					<li style="padding:20px 0;">
						<label>&nbsp;</label>
						<input type="hidden" name="goods_id" value="<?php echo ($goods["goods_id"]); ?>"/>
						<input type="hidden" name="goods_price" value="<?php echo ($goods["shop_price"]); ?>"/>
							
							<span><a href="javascript:document.getElementById('submit').submit();"  class="goods_sub goods_sub_gou" >加入购物车</a></span>
		...
		<div class="shop_goods_bd_xiangqing clearfix">
			...
			<div class="shop_goods_bd_xiangqing_content clearfix">
				<div id="xiangqing_content_1" class="xiangqing_contents clearfix">
					...
					<p>商品名称:<?php echo ($goods["goods_name"]); ?></p>
					<p>商品描述:<?php echo ($goods["goods_brief"]); ?></p>
					<p>市场价格:<?php echo ($goods["market_price"]); ?></p>
					<p>商店价格:<?php echo ($goods["shop_price"]); ?></p>
					<p>促销价格:<?php echo ($goods["promote_price"]); ?></p>
				
				</div>
				<div id="xiangqing_content_2" class="xiangqing_contents clearfix">
					<p>商品评论：<?php echo ($attrs); ?></p>
				</div>
