        ...
        <table width="90%" id="general-table" align="center" style="display: table;">
			<tbody>
				<tr>
					...
					<td><input type="text" name="goods_name" placeholder="诺基亚N85" size="30"><span class="require-field">*</span></td>
				</tr>
				<tr>
					<td class="label">商品货号： </td>
					<td><input type="text" name="goods_sn" placeholder="ECS000032" size="20" onblur="checkGoodsSn(this.value,'32')"><span id="goods_sn_notice"></span><br>
            ...
            <tr>
				...
				<td><input type="text" name="shop_price" placeholder="3010.00" size="20" onblur="priceSetted()">
				<input type="button" value="按市场价计算" onclick="marketPriceSetted()">
				<span class="require-field">*</span></td>
			</tr>
			<tr>
            <td class="label">会员价格：</td>
            <td><input type="text" name="user_price" placeholder="3010.00" size="20" onblur="priceSetted()"></td>
          </tr>

          <tr>
            <td class="label">市场售价：</td>
            <td><input type="text" name="market_price" placeholder="3612.00" size="20">
          ...
          <tr>
            ...
            <td id="promote_3"><input type="text" id="promote_1" name="promote_price" placeholder="2750.00" size="20"></td>
          </tr>
          <tr id="promote_4">
